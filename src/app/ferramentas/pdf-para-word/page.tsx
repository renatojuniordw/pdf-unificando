      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-12">
        <div className="max-w-2xl flex flex-col gap-6">
          <div className="bg-slate-950 border-4 border-slate-950 shadow-[4px_4px_0px_#000] p-4 flex items-center gap-3">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="#ccff00" strokeWidth="2" strokeLinecap="square"><circle cx="10" cy="10" r="8"/><path d="M10 6v4l3 3"/></svg>
            <p className="text-[#ccff00] font-mono text-xs uppercase tracking-widest">PDFs digitalizados (escaneados) podem não manter a formatação original.</p>
          </div>
          {status === 'idle' && <DropZone accept={{'application/pdf':['.pdf']}} onDrop={handleDrop} />}
