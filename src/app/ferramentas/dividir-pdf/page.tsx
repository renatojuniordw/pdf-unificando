      ...
      <section className="max-w-4xl mx-auto px-6 py-24">
        <div className="prose prose-slate max-w-none">
          <h2 className="text-3xl font-black uppercase tracking-tighter border-b-4 border-slate-950 pb-2 mb-8">
            Como dividir páginas de um PDF online
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border-4 border-slate-950 p-6 shadow-[4px_4px_0px_#000]">
              ...
              <h3 className="font-bold uppercase mb-2">Intervalo</h3>
              <p className="text-sm text-slate-600 font-mono">Digite as páginas que deseja extrair (ex: 1-5 ou 1,3,5).</p>
            </div>
            <div className="border-4 border-slate-950 p-6 shadow-[4px_4px_0px_#000]">
              <span className="text-4xl font-black text-slate-200 block mb-2">02</span>
              <h3 className="font-bold uppercase mb-2">Upload</h3>
              <p className="text-sm text-slate-600 font-mono">Selecione o arquivo PDF original para processamento.</p>
            </div>
            <div className="border-4 border-slate-950 p-6 shadow-[4px_4px_0px_#000]">
              <span className="text-4xl font-black text-slate-200 block mb-2">03</span>
              <h3 className="font-bold uppercase mb-2">Extrair</h3>
              <p className="text-sm text-slate-600 font-mono">Baixe o novo arquivo contendo apenas as páginas selecionadas.</p>
            </div>
          </div>
          <div className="mt-8 flex justify-center">
            <Link 
              href="/tutoriais/como-dividir-pdf"
          ...
          <div className="mt-16">
            ...
            <div className="space-y-6">
              ...
              <div className="border-4 border-slate-950 p-6">
                ...
                <p className="text-sm text-slate-600 font-mono">Não. Nós criamos uma cópia com as páginas desejadas. Seu arquivo original permanece intacto e é excluído do nosso sistema após o uso.</p>
              </div>
            </div>
          </div>
        </div>
