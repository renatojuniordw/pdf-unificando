      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex items-center justify-between w-full">
        <div className="flex items-center gap-3">
          <Link href="/" data-testid="header-logo-home" className="group flex items-center gap-3">
            ...
            <span className="font-black text-white text-sm uppercase tracking-widest hidden sm:block">
              Unificando
            </span>
          </Link>
        </div>
        ...
        >
          ...
          >
            ...
            >
              Ferramentas
              <span
                className={`inline-flex transition-transform duration-150 ${toolsOpen ? "rotate-180" : "rotate-0"}`}
              >
                <svg
                  width="10"
                  height="10"
                  ...
                  <li key={tool.slug}>
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[8px] font-mono text-slate-600 leading-tight line-clamp-1">
                          {tool.description}
                        </span>
                      </div>
                    </Link>
      ...
      >
        <div className="flex flex-col gap-2">
          ...
          >
            Ferramentas
            <span
              className={`inline-flex transition-transform duration-150 ${mobileToolsOpen ? "rotate-180" : "rotate-0"}`}
            >
              <svg
                width="12"
                height="12"
