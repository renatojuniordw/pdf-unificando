...
export const tools: ToolDefinition[] = [
  {
    ...
    seoDescription: 'Comprima PDFs online grátis, sem cadastro. Seus arquivos não são armazenados.',
    icon: 'compress',
    tier: 1,
    accept: ['.pdf'],
    multiple: false,
  ...
  },
  {
    ...
    seoDescription: 'Junte múltiplos PDFs online grátis. Reordene e combine sem limites.',
    icon: 'merge',
    tier: 1,
    accept: ['.pdf'],
    multiple: true,
  ...
  },
  {
    ...
    seoDescription: 'Converta PDF para Word (.docx) online grátis. Mantém formatação.',
    icon: 'pdf-to-word',
    tier: 1,
    accept: ['.pdf'],
    multiple: false,
